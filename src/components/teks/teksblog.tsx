        ...
        <>
            {loading ? (
                ...
                <div className='text-[15px] relative left-[100px] top-[120px] z-20'>
                    ...
                    <a className='text-[#002157] font-bold relative left-[300px] z-10' href="/beritabaru">See more...</a>
                    ...
                    <p className='absolute top-7 left-[900px] font-bold text-[20px] text-[#002157]'>Popular Post
                        <a className='text-[#002157] font-bold relative z-10 left-[130px]' href="/beritapopulate">See more...</a></p>
                </div >
            )}
        </>
    )
    ...
    return (
        <>
            <div className='text-[10px] relative left-[180px] top-[50px]'>
                ...
                <a className='text-[#002157] font-bold relative left-[-80px] bottom-3' href="/beritabaru">See more...</a>
                ...
                <p className='absolute top-2 left-[120px] font-bold text-[7px] text-[#002157]'>Popular Post
                    <a className='text-[#002157] font-bold relative z-10 left-[30px] text-[7px]' href="/beritapopulate">See more...</a></p>
            </div>
        </>
    );
}
