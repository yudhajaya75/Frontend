        ...
        <div className='mt-20 '>
            ...
            <div className="w-full  h-[300px] p-2 lg:h-[700px] flex justify-around mt-20 lg:m-0">
                ...
                <div className="w-[150px] h-[150px] md:w-[250px] md:h-[250px] lg:w-[400px] xl:w-[500px] relative lg:mr-10 lg:mt-0">
                    <img className="absolute -z-10 right-0 lg:top-[10px] sm-440:top-[-20px] sm-440:w-[200px] sm-440:hidden sm:hidden md:hidden lg:block lg:w-[500px] lg:h-[500px]" src='http://localhost:3000/images/bgpeople.webp' alt="background-people" />
