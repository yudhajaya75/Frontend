    ...
    return (
        <div className="navbar">
            ...
            <ul className="listnav">
                <a href="/home">
                    <li className="teksnav" style={{ color: "#074288" }}>
                        Home
                    </li>
                </a>
                <div>
                ...
                <a href="/blog">
                    <li className="teksnav2" style={{ color: "#4B4B4B" }}>
                        Blog
                    </li>
                </a>
                <a href="/about">
                    <li className="teksnav3" style={{ color: "#4B4B4B" }}>
                        About Us
                    </li>
                </a>
                <a href="/contact">
                    <li className="teksnav4" style={{ color: "#4B4B4B" }}>
                        Contact Us
                    </li>
                </a>
