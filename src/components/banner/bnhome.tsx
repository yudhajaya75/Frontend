                ...
                >
                    {contents.map((res: any) => (
                        <SwiperSlide key={res.id}>
                            <div className="relative left-[40px] lg:top-[12%] sm-440:top-[-20px] sm-440:w-[200px] sm-440:hidden sm:hidden md:hidden lg:block lg:w-[400px] lg:h-[500px] rounded">
                                <img src={res.image} alt="background-people" style={{ borderRadius: '10%' }} />
                            </div>
                        </SwiperSlide>
                    ))}
                </Swiper>
            ...
            <div className='mt-20 '>
                <div>
                    ...
                    <div className="w-full  h-[300px] p-2 lg:h-[700px] flex justify-around mt-20 lg:m-0">
                        <div className=' h-[120px] relative bottom-[20%] right-[24%] lg:w-[500px] lg:flex flex-col gap-8'>
