...
const Cards = () => {
    ...
    return (
        ...
        {loading ? (
            ...
            <div className="font-extralight gap-5 lg:gap-10 grid md:grid-cols-2">
            {hyperlink.map((res, index) => (
                <div
                key={index}
                className="grid grid-rows-2 md:grid-rows-none lg:grid-cols-2 md:flex-row border border-gray-300 rounded-md w-full shadow-lg"
                >
                <Image
