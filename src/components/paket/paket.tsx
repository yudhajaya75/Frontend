...
function paket() {
    return (
        <>
            <div className='flex gap-5 pt-[300px]'>
                <div className='w-[350px] h-[740px] relative bottom-[200px] left-[100px] rounded-md mb-[100px] bg-white'
                    ...
                    <div className='p-10'>
                        ...
                        <div className='pt-5 font-bold'>
                            <button className='bg-[#F3440D] px-[74px] rounded-lg text-white py-2 hover:bg-[#ef592b]'>
                                <p className=''>Daftar sekarang</p></button>
                        </div>
                ...
                <div className='w-[350px] h-[740px] bg-white relative bottom-[200px] left-[100px] rounded-md mb-[100px]'
                    style={{ boxShadow: '0px 0px 10px -5px rgba(0, 0, 0, 0.75)' }}>
                    <div className='p-10'>
                        <p className='text-[15px] font-bold bg-[#F3440D] text-white absolute right-10 top-12 rounded-lg text-WHITE px-2'>POPULAR</p>
                        <p className='text-[24px] font-bold text-[#103D72]'>PELATIHAN</p>
                        <p className='text-[#BFBFBF] pt-1'>Lorem Ipsum</p>
                        <p className='text-[16px] font-bold pt-2 text-[#103D72]'>Mulai Dari</p>
                        <p className='text-[48px] text-[#103D72]'>Rp 88.000</p>
                        <div className='pt-5 font-bold'>
                            <button className='bg-[#F3440D] rounded-lg text-white py-2 px-[74px] hover:bg-[#ef592b]'>Daftar sekarang</button>
                        </div>
                        <p className='text-[20px] pt-7 text-[#103D72]'>Fitur :</p>
                        <div className='pt-7'>
                            <img src="../images/ceklis.webp" className='relative top-0 left-2 w-[20px]' alt="" />
                            <p className='text-[20px] relative bottom-7 left-10'>Sertifikat</p>
                        </div>
                        ...
                        <div className='relative bottom-[50px]'>
                            <img src="../images/ceklis.webp" className='relative top-0 left-2 w-[20px]' alt="" />
                            <p className='text-[20px] relative bottom-7 left-10'>Konseling 1 on 1</p>
                        </div>
                    </div>
                </div>
                <div className='w-[350px] h-[740px] relative bottom-[200px] left-[100px] rounded-md mb-[100px] bg-white'
                    style={{ boxShadow: '0px 0px 10px -5px rgba(0, 0, 0, 0.75)' }}>
                    <div className='p-10'>
                        <p className='text-[24px] font-bold text-[#103D72]'>Layanan konseling individu pasangan & keluarga</p>
                        <p className='text-[16px] font-bold pt-2 text-[#103D72]'>Mulai Dari</p>
                        <p className='text-[48px] text-[#103D72]'>Rp 100.000</p>
                        <div className='pt-5 font-bold'>
                            <button className='bg-[#F3440D] rounded-lg text-white py-2 px-[74px] hover:bg-[#ef592b]'>Daftar sekarang</button>
